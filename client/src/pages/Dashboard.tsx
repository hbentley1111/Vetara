                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-1 mt-1">
                            <div className="flex text-yellow-400">
                              {[...Array(5)].map((_, i) => (
                                <svg key={i} className={`w-3 h-3 ${i < Math.floor(parseFloat(provider.qualityMetrics?.overallRating || '0')) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
